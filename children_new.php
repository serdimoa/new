            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="menu-list nav-active"><a href=""><i class="fa fa-home"></i> <span>Реестр детей</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="active"><a href="children_new.php"><i class="fa fa-plus"></i> <span>Добавить ребенка</span></a></li>
                    </ul>
                </li>
...
<script>
    ...
    function sendsave(){
        webix.ajax("children_new_insert.php?nameinp="      +   gid('nameinp').value +
